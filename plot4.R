...
plot4 <-
{
  ...
  with(d, {
      ...
      plot(col_dt, Global_active_power, type="l", xlab="", ylab="Global Active Power" )
       
      ### Plot "Voltage"
      plot(col_dt, Voltage, type="l", xlab="datetime", ylab="Voltage" )
       
      
      ### Plot Energy Sub Metering 
      plot(col_dt, Sub_metering_1, type="l", xlab="", ylab="Energy sub metering", col="black" )
      lines(col_dt, Sub_metering_2, col="red" )
      lines(col_dt, Sub_metering_3, col="blue" )
      legend("topright", 
      ...
      plot(col_dt, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power" )
